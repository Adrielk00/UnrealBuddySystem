...
## FEATURES:
* [+] Bot model selection: Choose your companion’s 3D model and skin.<br>
* [+] Respawn: Choose whether you want your companion to respawn when they die.<br>
* [+] Favorite weapons: Set your companion’s preferred weapons.<br>
* [+] Inventory preferences: Adjust settings for bots to spawn with a default inventory (Maximum of 16 items/weapons).<br>
* [+] Health: Customize your companion's initial health.<br>
* [+] HUD customization: Enable or disable the custom HUD.<br>
...
**"say Teleport"** - tells the buddy to teleport to you.<br>
**"say ThrowWeapon"** - the buddy will throw their current weapon.<br>
**"say Use <Weapon>"** - the buddy will switch to this weapon (if they have it) and set it as their new "favorite weapon". Example: "say use ASMD".<br>
**"say Give <Ammo>"** - gives the buddy ammo from your inventory only if you have it first.<br>
**"say Give <Armor/Suit/ShieldBelt>"** - takes the item from your inventory, removes it, and gives it to your buddy.<br>
**"say God"** - activates god mode for your buddy. Can be toggled on/off.<br>
**"say AllAmmo"** - activates infinite ammo for all weapons of your buddy.<br>
**"say AllWeapons"** - gives all default Unreal weapons to your buddy.<br><br><br>


## REQUIREMENTS:
* **Unreal Gold** (installed on your system).<br>
* **Jackrabbit Mutators** (required for integration with the configuration interface) (INCLUDED).<br><br><br>
...
* [+] Reaparacición: Elige si quieres que tu compañero reaparezca cuando se muere.<br>
* [+] Armas favoritas: Configura las armas preferidas de tu compañero.<br>
* [+] Preferencias de inventario: Ajusta las configuraciones para que los bots aparezcan con un inventario predeterminado (Máximo de 16 items/Armas).<br>
* [+] Salud: Personaliza la salud inicial de tu compañero.<br>
* [+] Personalización del HUD: Activa o desactiva el HUD personalizado.<br>
...
**"say Teleport"** - le dice al compañero que se teletransporte hacia ti.<br>
**"say ThrowWeapon"** - el compañero lanzará su arma actual.<br>
**"say Use <Weapon>"** - el compañero cambiará a esta arma (si la tiene) y la establecerá como su nueva "arma favorita". Ejemplo: "say use ASMD".<br>
**"say Give <Ammo>"** - le da munición al compañero desde tu inventario solo si la tienes primero.<br>
**"say Give <Armor/Suit/ShieldBelt>"** - Toma el item en tu inventario, la elimina y se la da a tu compañero.<br>
**"say God"** - Activa el modo dios a tu compañero. se puede activar/desactivar.<br>
**"say AllAmmo"** - Activa la munición infinita para todas las armas de tu compañero.<br>
**"say AllWeapons"** - Le da todas las armas predeterminadas de Unreal para tu compañero.<br><br><br>

## REQUISITOS:
* **Unreal Gold** (instalado en tu sistema).<br>
* **Mutadores Jackrabbit** (se requiere para la integración con la interfaz de configuración) (INCLUIDOS).<br><br><br>
